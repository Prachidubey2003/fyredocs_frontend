          ...
          <div className="prose prose-neutral dark:prose-invert max-w-none space-y-8">
            ...
            <section>
              ...
              <p className="text-muted-foreground mb-4">
                Fyredocs uses cookies for the following purposes:
              </p>
              <ul className="list-disc pl-6 space-y-2 text-muted-foreground">
                <li>
                  <strong>Essential cookies:</strong> Required for the website
                  to function properly, including user authentication and
                  security.
                </li>
                <li>
                  <strong>Preference cookies:</strong> Remember your settings
                  like theme preferences and language selection.
                </li>
                <li>
                  <strong>Analytics cookies:</strong> Help us understand how
                  visitors interact with our website so we can improve our
                  service.
                </li>
                <li>
                  <strong>Performance cookies:</strong> Help us measure and
            ...
            <section>
              ...
              <p className="text-muted-foreground">
                ...
                including Google Analytics for website analytics and Stripe for
                payment processing. These third parties have their own privacy
                policies.
              </p>
            </section>
            ...
            <section>
              ...
              <p className="text-muted-foreground mt-4">
                Note that blocking cookies may affect the functionality of our
                website.
              </p>
            </section>
