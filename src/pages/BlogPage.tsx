...
const blogPosts = [
  ...
  },
  {
    ...
    description:
      'Making your PDFs accessible to everyone, including users with disabilities.',
    category: 'Guides',
    date: '2025-01-10',
    readTime: '8 min read',
  },
  ...
  },
  {
    ...
    description:
      'Learn how to password protect and encrypt your PDF files for maximum security.',
    category: 'Security',
    date: '2024-12-20',
    readTime: '7 min read',
  },
      ...
      <div className="container py-16 md:py-24">
        <div className="max-w-3xl mx-auto text-center mb-16">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            Fyredocs <span className="text-gradient-primary">Blog</span>
          </h1>
