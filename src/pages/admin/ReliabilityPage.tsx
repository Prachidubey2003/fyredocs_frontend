...
const ReliabilityPage = () => {
  ...
  const handleRefresh = useCallback(
    () => queryClient.resetQueries({ queryKey: ['admin', 'reliability'] }),
    [queryClient]
  );
      ...
      <div className="space-y-6 px-4 py-8">
            ...
            <CardContent className="flex items-center gap-3 p-4">
              ...
              <div className="min-w-0 flex-1">
                ...
                {isLoading ? (
                  ...
                  <p
                    className={`text-3xl font-bold leading-tight ${rate >= 95 ? 'text-green-600' : rate >= 80 ? 'text-yellow-600' : 'text-red-600'}`}
                  >
                    {rate.toFixed(1)}%
                  </p>
                )}
        ...
        <Card>
          <CardHeader>
            ...
            <CardDescription>
              Daily failures vs total jobs — last 30 days
            </CardDescription>
          </CardHeader>
          <CardContent>
            {isLoading ? (
        ...
        {(d?.planLimitHits?.length ?? 0) > 0 && (
          <Card>
            <CardHeader>
              ...
              <CardDescription>
                Users hitting plan limits over time
              </CardDescription>
            </CardHeader>
            <CardContent>
              <Table>
