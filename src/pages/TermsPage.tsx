          ...
          <div className="prose prose-neutral dark:prose-invert max-w-none space-y-8">
            <section>
              ...
              <p className="text-muted-foreground">
                By accessing and using FileBlossom's services, you agree to be bound by these Terms of Service. If you do not agree to these terms, please do not use our services.
              </p>
            </section>
            ...
            <section>
              ...
              <p className="text-muted-foreground">
                FileBlossom provides online PDF tools including but not limited to: PDF merging, splitting, compression, conversion, OCR, and security features. Our services are provided "as is" and we reserve the right to modify or discontinue any feature at any time.
              </p>
            </section>
            ...
            <section>
              ...
              <p className="text-muted-foreground">
                FileBlossom is not liable for any indirect, incidental, special, consequential, or punitive damages resulting from your use of our services. Our total liability shall not exceed the amount you paid for the service in the past 12 months.
              </p>
            </section>
            ...
            <section>
              ...
              <p className="text-muted-foreground">
                For questions about these Terms of Service, please contact us at legal@fileblossom.com.
              </p>
            </section>
          </div>
        </div>
